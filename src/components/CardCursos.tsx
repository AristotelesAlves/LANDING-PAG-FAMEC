...
export function CardCursos(props: ICardCursos){
    return(
        <div className="bg-white p-3 shadow-xl rounded-xl w-[340px] h-[400px] flex flex-col justify-center">
            ...
            <p className="w-[250px] border-l-[3px] border-blue-950 ml-6 pl-5 my-5">
                {props.description}
            </p>
